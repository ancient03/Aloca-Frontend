...
export const Sidebar = ({ collapsed, onToggle }) => {
  ...
  return (
    ...
    >
      {/* Logo */}
      <div
        className={`flex items-center h-16 border-b border-gray-100 px-4 flex-shrink-0 ${collapsed ? "justify-center" : "gap-3"}`}
      >
      ...
      <nav className="flex flex-col flex-1 gap-1 px-3 py-4 overflow-y-auto">
        ...
        {user?.role === "admin" && (
          <>
            <div
              className={`my-3 border-t border-gray-100 ${collapsed ? "" : ""}`}
            />
            {!collapsed && (
      ...
      <div className="flex-shrink-0 p-3 border-t border-gray-100">
        {!collapsed ? (
          <div className="flex items-center gap-3 px-2 py-2 transition-colors rounded-xl hover:bg-gray-50">
            ...
            <button
              ...
              className="flex items-center justify-center flex-shrink-0 transition-colors rounded-lg w-7 h-7 bg-red-50 hover:bg-red-100"
              title="Logout"
            >
          ...
          <button
            onClick={handleLogout}
            className="flex items-center justify-center w-full py-2 transition-colors rounded-xl bg-red-50 hover:bg-red-100"
            title="Logout"
          >
